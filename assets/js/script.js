    ...
    agregarProductoBtn.addEventListener('click', () => {
        ...
        productoDiv.innerHTML = `
            <select class="selectProducto">
                    <option value="1" data-precio="1500">Completo ($1500)</option>
                    <option value="2" data-precio="1500">Score ($1500)</option>
                    <option value="3" data-precio="1000">Kryzpo ($1000)</option>
                    <option value="4" data-precio="1000">Detodito ($1000)</option>
                    <option value="5" data-precio="1000">Dorito ($1000)</option>
                    <option value="6" data-precio="850">Brownie Choc ($850)</option>
                    <option value="7" data-precio="700">Agua Mineral ($700)</option>
                    <option value="8" data-precio="700">Capri ($700)</option>
                    <option value="9" data-precio="700">Leche en Caja ($700)</option>
                    <option value="10" data-precio="700">Bebida ($700)</option>
                    <option value="11" data-precio="550">Morocha ($550)</option>
                    <option value="12" data-precio="500">Super 8 ($500)</option>
                    <option value="13" data-precio="500">BigTime ($500)</option>
                    <option value="14" data-precio="500">Choquita ($500)</option>
                    <option value="15" data-precio="500">Jugo en Caja ($500)</option>
                    <option value="16" data-precio="500">Café ($500)</option>
                    <option value="17" data-precio="500">Té ($500)</option>
                    <option value="18" data-precio="300">Tuyo ($300)</option>
                    <option value="19" data-precio="200">Masticable Frutilla / Sandia ($200)</option>
                    <option value="20" data-precio="200">Coya ($200)</option>
                    <option value="21" data-precio="3000">Salchipapa ($3000)</option>
                    <option value="22" data-precio="2000">Papas Fritas ($2000)</option>
                    <option value="23" data-precio="500">Vaso Bebida ($500)</option>
            </select>
